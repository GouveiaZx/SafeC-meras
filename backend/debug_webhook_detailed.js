...
// Caminho real do arquivo que existe
const REAL_FILE_PATH = '/opt/media/bin/www/record/live/4ccfd5af-ffaf-4a86-8e3e-ffa0fc1529dd/record/live/4ccfd5af-ffaf-4a86-8e3e-ffa0fc1529dd/2025-08-10/2025-08-10-11-11-33-0.mp4';
const REAL_FILE_NAME = '2025-08-10-11-11-33-0.mp4';
...
async function testWebhookWithRealPath() {
  ...
  // Dados do webhook com caminho real
  const webhookData = {
...
async function testDifferentPathFormats() {
  ...
  const testCases = [
    ...
    },
    {
      ...
      file_path: null,
      file_name: '4ccfd5af-ffaf-4a86-8e3e-ffa0fc1529dd/record/live/4ccfd5af-ffaf-4a86-8e3e-ffa0fc1529dd/2025-08-10/2025-08-10-11-11-33-0.mp4'
    }
  ];
